...
import questions from './data/final_complete_all_1048_questions.json';
        ...
        <div className="question-box">
          ...
          <div className="options">
            {Object.entries(currentQuestion.options).map(([key, value]) => (
              <button
                key={key}
                className={`option-button ${selectedOption === key ? (key === currentQuestion.answer ? 'correct' : 'wrong') : ''} ${answered && key === currentQuestion.answer && !isCorrect ? 'correct' : ''}`}
